...
| CI | ✅ Done | [.github/workflows/ci.yml](.github/workflows/ci.yml) — `tsc --noEmit`, lint, test, build on push/PR to `main`. |

## Review findings addressed

Findings surfaced via manual code review across five passes; all fixes verified with `tsc --noEmit`, `eslint`, `vitest run`, and (except where noted) live browser checks.
