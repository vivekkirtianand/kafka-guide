...
export const producerConsumerWalkthrough: Walkthrough = {
  ...
  lessons: [
    ...
    public OrderEvent {
      ...
      watchOut:
        "This is a hand-written check, not a schema. Nothing stops a different producer writing a differently-shaped JSON object to `orders`. Module 5 (schemas and data contracts) closes that gap.",
    },
    {
      id: "producer-config",
