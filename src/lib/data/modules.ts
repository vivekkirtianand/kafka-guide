    ...
    exercises: [
      {
        ...
        successCriteria: [
          ...
          "You use the full docker exec plus --bootstrap-server form for every command, matching whichever lab you are actually running (localhost:9092 inside kafka-lab-a for Lab A, kafka-1:19092 inside kafka-lab-kafka-1 for Lab B), and you attach docker exec -i specifically on the two piped console-producer commands — without it stdin never reaches the producer and neither test proves anything",
