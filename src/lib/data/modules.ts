    ...
    exercises: [
      {
        ...
        successCriteria: [
          ...
          "You confirm /subjects/order-events-value/versions still reports all 3 registered versions, and say what actually protected them: the container was stopped, not its volume deleted, so nothing about its persisted state was touched — down -v is the destructive one",
